#!/usr/bin/env python3
"""
Encrypted PDF Export Service for Manny Threat Intel
...
def create_analysis_pdf(analysis_result: Dict, output_path: str,
    ...
    try:
        ...
        # Title
        story.append(Paragraph("Manny Threat Intel", title_style))
        ...
        story.append(Spacer(1, 10))
        story.append(Paragraph(
            "<font size='8' color='#666666'>This report was generated by Manny Threat Intel. "
